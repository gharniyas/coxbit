  ...
  const coreTeam = [
    {
      ...
      bio: "Ram Kumar leads the overall strategic direction and operations of the Centre of Excellence in Biotechnology. With his MBA background and extensive leadership experience, he drives organizational growth, oversees strategic partnerships, and ensures the achievement of CoEB's mission in advancing biotechnology research and innovation.",
      expertise: [
    ...
    },
    {
      ...
      bio: "Radhika oversees the day-to-day operations and maintenance of all CoEB facilities. She ensures optimal facility utilization, coordinates maintenance schedules, and manages the infrastructure that supports our research activities.",
      expertise: [
        "Facility Operations",
    ...
    },
    {
      ...
      bio: "Vignesh handles all financial transactions, budget management, and accounting operations for CoEB. He ensures proper financial documentation, manages vendor payments, and maintains compliance with financial regulations.",
      expertise: [
