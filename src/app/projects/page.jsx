  ...
  return (
    <div className="min-h-screen bg-gray-50 py-6 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Project Tabs */}
        <TabNavigation tabs={tabs} activeTab={activeProject} onTabChange={setActiveProject} />
        ...
        <div className="bg-white rounded-b-lg shadow-lg p-6">
          ...
          <div 
            ...
            style={{
              backgroundColor: currentProject.color === 'blue' ? '#eff6ff'
                : currentProject.color === 'green' ? '#f0fdf4'
                : currentProject.color === 'purple' ? '#faf5ff'
                : '#fff7ed',
              borderColor: currentProject.color === 'blue' ? '#3b82f6'
                : currentProject.color === 'green' ? '#10b981'
                : currentProject.color === 'purple' ? '#a855f7'
                : '#f97316'
            }}
          >
            {currentProject.outlay !== 'N/A' && (
              <p className="font-semibold text-gray-900">Project Outlay: {currentProject.outlay}</p>
            )}
            <p className="text-gray-700">
              {currentProject.outlay !== 'N/A' ? 'Funded by: ' : 'Implemented by: '}
